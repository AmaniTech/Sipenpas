                                    ...
                                    <tbody>
                                        @foreach ($kategori as $k)
                                            <tr>
                                                ...
                                                <td>{{$k->nama}}</td>
                                                <td>
                                                    <button href='' class="btn btn-warning border border-white" data-bs-toggle="modal" data-bs-target="#ekatgeori_{{$k->id}}">Edit</button>
                                                    <form action="/kategori/delete/{{$k->id}}" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
                                            ...
                                            <div class="modal fade" id="ekatgeori_{{$k->id}}" tabindex="-1" aria-labelledby="ekatgeori_{{$k->id}}Label" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="ekatgeori_{{$k->id}}Label">Edit Data</h1>
